# RGB-Reefscape-1806
RGB-Reefscape-1806 controls BTF-LIGHTING 9.8FT WS2811 WS2812B IC RGB 12VDC lights with an Orange Pi 5 for use on a 2026 FRC Robot. Runs alongside PhotonVision on the same device.

## Requirements
- RGB-Reefscape-1806 must comply with all FRC Control System rules
...
- RGB-Reefscape-1806 will be able to partition the light string into 2 types of sections:
...
- RGB-Reefscape-1806 will need to be capable of running headless, and will need to be easilly installed on an Orange Pi 5.
- If possible RGB-Reefscape-1806 should support being fed information over USB from a desktop application reading network tables and forwarding the data to it for use on the driver station.
